...
class Troop:
    ...
    def move(self, pos_x, pos_y, dest_x, dest_y):
        ...
        self.pos = pygame.Vector2(target_x - pos_x, target_y - pos_y)
    ...
    def character_rect(self, card):
        character_rect = self.animation(card).getCurrentFrame().get_rect(topleft=(self.x, self.y))
...
enemy_ptower_left = Towers("Enemy_Tower", 1000, 50, 500, 5, 1.5, 2, 5, os.path.join(IMG_DIR, "tower.jpg"), False)
enemy_ptower_right = Towers("Enemy_Tower", 1000, 50, 500, 500, 1.5, 15, 5, os.path.join(IMG_DIR, "tower.jpg"), False)
player_ptower_left = Towers("Player_Tower", 1000, 50, 5, 5, 1.5, 2, 18, os.path.join(IMG_DIR, "tower.jpg"), True)
player_ptower_right = Towers("Player_Tower", 1000, 50, 5, 5, 1.5, 15, 18, os.path.join(IMG_DIR, "tower.jpg"), True)
#crown tower setup
enemy_crown_tower = Crown_Tower("Enemy_Crown_Tower", 1500, 75, 7, 5, 1, 9, 21, os.path.join(IMG_DIR, "King_Tower_Red.jpg"), False)
player_crown_tower = Crown_Tower("Player_Crown_Tower", 1500, 75, 7, 5, 1.2, 9, 2, os.path.join(IMG_DIR, "King_Tower_Blue.jpg"), True)
